...
class ExampleCandidateModel {
  ...
  factory ExampleCandidateModel.fromMap(Map<String, dynamic> map) {
    return ExampleCandidateModel(
      ...
      color: List<Color>.from(map['color'].map((c) => Color(c))),
    );
  }
}
...
final List<ExampleCandidateModel> candidates = [
  ExampleCandidateModel(
    ...
    placeId: '12345',
    imageUrl:
        'https://images.pexels.com/photos/19065473/pexels-photo-19065473/free-photo-of-a-view-of-the-blue-mosque-from-a-window.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
